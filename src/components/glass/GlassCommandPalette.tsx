...
import { Search, CornerDownLeft, ArrowUp, ArrowDown, Clock, X } from "lucide-react";
        ...
        <>
          ...
          <motion.div
            ...
            className={cn(
              ...
              "glass-float rounded-2xl border border-border overflow-hidden",
              className
            )}
          >
            {/* Search input */}
            <div className="flex items-center gap-3 px-4 py-3 border-b border-border">
              ...
              <kbd className="hidden sm:inline-flex h-5 items-center gap-1 rounded border border-border px-1.5 text-[10px] font-medium text-muted-foreground">
                ESC
              </kbd>
            </div>
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            ...
                            idx === selectedIndex ? "bg-accent/50 text-foreground" : "text-foreground/80 hover:bg-accent/30"
                          )}
                        >
