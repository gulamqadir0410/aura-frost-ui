...
interface GlassTabsProps extends React.ComponentPropsWithoutRef<typeof TabsPrimitive.Root> {
  tabs?: GlassTabItem[];
...
interface GlassTabsTriggerProps extends React.ComponentPropsWithoutRef<typeof TabsPrimitive.Trigger> {
  badge?: React.ReactNode;
  icon?: React.ReactNode;
  closable?: boolean;
  onClose?: () => void;
...
export type { GlassTabItem, GlassTabsProps, GlassTabsTriggerProps };
